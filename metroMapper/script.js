				...
				//if this train is in service, create an element
					if (currentPoint) {
						...
						var element = document.createElement("circle")
							...
							element.title = direction + " [" + lines[l].name + "] : " + lines[l].trains[t][0] + "-" + lines[l].trains[t][1] + " (" + (travelFraction * 100).toFixed(1) + "%)"
						...
						var text = document.createElement("text")
							...
							text.setAttribute("x", Math.floor((((Number(currentPoint[1]) * 10000000) + 740000000) / 35000 + 20) * 100))
							text.setAttribute("y", Math.floor(10000 - (((Number(currentPoint[0]) * 10000000) - 407300000) / 35000 + 47) * 100))
