window.onload = function() {
	...
	/* create page */
		var demoArray = ["flagMaker","pulsePather", "runJumper", "mazeMaker2", "gridDrawer", "laserSimulator", "timeStopper", "tipRounder", "magnetMaker", "wordsearchBuilder", "pegJumper", "toneMaker", "chromaCreatures", "pieceFlipper", "mineFinder", "stockTracker", "noughtCrosser", "pawnPusher", "graphMaker", "checkersPlayer", "hexSequencer", "pencilPather", "brickBreaker", "blockDescender", "metroMapper", "snakeSnacker", "wordShuffler", "quoteTyper", "hueMatcher", "xmlParser","pitchPlayer","dotConnector","numberCruncher","bladesDodger","webDepictor","weatherExplorer","pixelPainter","sphereCollector","codeRunner","shapeAnimator","tickTocker","balloonPopper","robotDirector","colorFlooder","diceRoller","chordAnalyzer","wordFinder","mazeMaker","htmlConverter","tileSlider","wordCounter","clipPather"]
